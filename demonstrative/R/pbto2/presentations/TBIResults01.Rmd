...
## Binary Outcome Dataset {.smallest}
...
d.stat <- d  %>% melt(id.vars=c('uid', 'gos')) %>% 
  ...
  mutate(type = ifelse(variable %in% static.features, 'Static', 'Timeseries')) %>%
  arrange(type)

d.stat %>% data.frame #%>% knitr::kable(pad=0, padding=0)
```
...
========================================================
<center>
<img src="/Users/eczech/repos/portfolio/demonstrative/R/pbto2/presentations/images/no_interp/actual_icp1.png" width="600px" height="600px"/>
</center>

Results (PaCO2 levels)
========================================================
<center>
<img src="/Users/eczech/repos/portfolio/demonstrative/R/pbto2/presentations/images/no_interp/actual_paco2.png" width="600px" height="600px"/>
</center>

Results (pH levels)
========================================================
<center>
<img src="/Users/eczech/repos/portfolio/demonstrative/R/pbto2/presentations/images/no_interp/actual_pha.png" width="600px" height="600px"/>
</center>

Results - PaO2 levels
========================================================
<center>
<img src="/Users/eczech/repos/portfolio/demonstrative/R/pbto2/presentations/images/no_interp/actual_pao2.png" width="600px" height="600px"/>
</center>

Results - PbtO2 levels
========================================================
<center>
<img src="/Users/eczech/repos/portfolio/demonstrative/R/pbto2/presentations/images/no_interp/actual_pbto2.png" width="600px" height="600px"/>
</center>
